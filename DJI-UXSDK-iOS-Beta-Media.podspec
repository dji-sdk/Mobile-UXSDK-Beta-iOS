Pod::Spec.new do |s|
  s.name = 'DJI-UXSDK-iOS-Beta-Media'
  s.version = '0.4.0'
  s.license = 'MIT'
  s.summary = 'Media utilities for DJI iOS UX SDK.'
...
#  s.source = { :git => 'https://github.com/dji-sdk/Mobile-UXSDK-Beta-iOS.git', :tag => s.version.to_s }
  ...
  s.source_files = 'UXSDKMedia/**/*.{h,m,swift}'
  s.exclude_files = 'UXSDKMedia/UXSDKMedia/Widget/LiveStreamWidget/**/*.{h,m,swift}'
  s.resource_bundle = { 'UXSDKMediaAssets' => 'UXSDKMedia/**/*.{xcassets,html,otf}' }
