Pod::Spec.new do |s|
  s.name = 'DJI-UXSDK-iOS-Beta-VisualCamera'
  s.version = '0.4.0'
  s.license = 'MIT'
  ...
  s.requires_arc = true
  s.swift_version = '5.0'
  s.module_name = 'UXSDKVisualCamera'
...
#  s.source = { :git => 'https://github.com/dji-sdk/Mobile-UXSDK-Beta-iOS.git', :tag => s.version.to_s }
  ...
  s.source_files = 'UXSDKVisualCamera/**/*.{h,m,swift}'
  s.resource_bundle = { 'UXSDKVisualCameraAssets' => 'UXSDKVisualCamera/**/*.{xcassets,html,otf}' }
